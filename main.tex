...
%  Added running titles to avoid mixing up paper versions of two or more unstapled manuscripts stored  together.
\usepackage{fancyhdr}
\pagestyle{fancy}
% \fancyhf{}% Clear header/footer
\fancyhead[C]{%
  \ifodd\value{page}\relax
    Generic manuscript template % Odd page header
  \else
